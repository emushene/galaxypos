            ...
            <div class="col-md-6">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                      <div class="form-group">
                                        @if($general_setting->pos_date_disable)
                                            <input type="text" name="created_at" id="created_at" class="form-control" placeholder="Choose date" />
                                        @else
                                            <input type="text" name="created_at" id="created_at" class="form-control date" placeholder="Choose date" onkeyup='saveValue(this);'/>
                                        @endif
                                          
                                      </div>
                                    </div>
                                    @if($general_setting->pos_reference_disable==0)
                                    <div class="col-md-3">
                                      <div class="form-group">
                                    ...
                                    @if($general_setting->pos_currency_sel_change) 
                                        <div class="col-md-2">
                                            <select name="currency_id" id="currency" class="form-control selectpicker" data-toggle="tooltip" title="" data-original-title="Sale currency" @php $freeze; @endphp>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group d-flex">
                                                <input class="form-control" type="text" id="exchange_rate" name="exchange_rate" readonly value="{{$currency->exchange_rate}}">
                    ...
                    <div class="payment-options">
                        <!-- new Added -->
                        @if(in_array("multi_payment",$options))
                        <div class="column-5">
                            <button style="background: #0984e3" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-multi-payment" id="multi-payment-btn"><i class="fa fa-credit-card"></i> {{'Multi Payment'}}</button>
                        </div>
                        @endif

                        @if(in_array("card",$options))
                        <div class="column-5">
                            <button style="background: #0984e3" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> {{trans('file.Card').'(F2)'}}</button>
                        </div>
                        @endif
                        @if(in_array("cash",$options))
                        <div class="column-5">
                            <button style="background: #00cec9" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> {{trans('file.Cash').'(F7)'}}</button>
                        </div>
                        @endif
                        ...
                        @endif
                        <div class="column-5">
                            <button style="background-color: #e28d02" type="button" class="btn btn-sm btn-custom" id="draft-btn"><i class="dripicons-flag"></i> {{trans('file.Draft').'(F4)'}}</button>
                        </div>
                        @if(in_array("cheque",$options))
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i> {{trans('file.Cheque').'(F9)'}}</button>
                        </div>
                        @endif
                        @if(in_array("gift_card",$options))
                        <div class="column-5">
                            <button style="background-color: #5f27cd" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="gift-card-btn"><i class="fa fa-credit-card-alt"></i> {{trans('file.Gift Card').'(F6)'}}</button>
                        </div>
                        @endif
                        @if(in_array("deposit",$options))
                        <div class="column-5">
                            <button style="background-color: #b33771" type="button" class="btn btn-sm btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="deposit-btn"><i class="fa fa-university"></i> {{trans('file.Deposit').'(F8)'}}</button>
                        </div>
                        @endif
                        ...
                        @endif
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-sm btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> {{trans('file.Recent Transaction').'(F3)'}}</button>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Multi Payment Option new Added -->
            <!-- payment modal -->
            <div id="add-multi-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        <input type="hidden" name="multi_payment_chk" id="multi_payment_chk" class="multi_payment_chk">
                                        <!-- Row 1# -->
                                        <div class="col-md-3 mt-1">
                                            <label>{{'Total Amount'}} *</label>
                                            <input type="text" name="paying_amount_0" class="form-control numkey" required step="any" readonly>
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Paying Amount')}} *</label>
                                            <input type="text" name="paid_amount_0" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <select name="paid_by_id_select_0" class="form-control selectpicker">
                                                @if(in_array("cash",$options))
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>{{'Total Amount'}} *</label>
                                            <input type="text" name="paying_amount_1" class="form-control numkey" step="any" readonly="readonly">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Paying Amount')}} *</label>
                                            <input type="text" name="paid_amount_1" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Due')}} : </label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <label>{{trans('file.Paid By')}}</label>
                                            <select name="paid_by_id_select_1" class="form-control selectpicker">
                                                @if(in_array("cash",$options))
                                                <option value="1">Cash</option>
                                                @endif
                                                @if(in_array("gift_card",$options))
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>{{'Total Amount'}} *</label>
                                            <input type="text" name="paying_amount_2" class="form-control numkey" step="any" readonly="readonly">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Paying Amount')}} *</label>
                                            <input type="text" name="paid_amount_2" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Due')}} : </label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <label>{{trans('file.Paid By')}}</label>
                                            <select name="paid_by_id_select_2" class="form-control selectpicker">
                                                @if(in_array("cash",$options))
                                                <option value="1">Cash</option>
                                                @endif
                                                @if(in_array("gift_card",$options))
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>{{'Total Amount'}} *</label>
                                            <input type="text" name="paying_amount_3" class="form-control numkey" step="any" readonly="readonly">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Paying Amount')}} *</label>
                                            <input type="text" name="paid_amount_3" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Due')}} : </label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <label>{{trans('file.Paid By')}}</label>
                                            <select name="paid_by_id_select_3" class="form-control selectpicker">
                                                @if(in_array("cash",$options))
                                                <option value="1">Cash</option>
                                                @endif
                                                @if(in_array("gift_card",$options))
                                        ...
                                        <div class="form-group col-md-12 cheque_multi">
                                            <label>{{trans('file.Cheque Number')}} *</label>
                                            <input type="text" name="cheque_no_multi" class="form-control">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>{{trans('file.Payment Note')}}</label>
                                            <textarea id="payment_note_multi" rows="2" class="form-control" name="payment_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-md-6 form-group">
                                            <label>{{trans('file.Sale Note')}}</label>
                                            <textarea rows="3" class="form-control" name="sale_note_multi"></textarea>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>{{trans('file.Staff Note')}}</label>
                                            <textarea rows="3" class="form-control" name="staff_note_multi"></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>{{'Total Amount'}} *</label>
                                            <input type="text" name="paying_amount" class="form-control numkey" required step="any" readonly>
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>{{trans('file.Paying Amount')}} *</label>
...
document.addEventListener('DOMContentLoaded', function() {
    document.addEventListener('keydown', function(event) {
        ...
        if (event.keyCode === 113) {
            document.getElementById('credit-card-btn').click();
        }
        // Check if the pressed key is F3 (key code 114)
        else if (event.keyCode === 114) {
            document.querySelector('[data-target="#recentTransaction"]').click();
        }
        // Check if the pressed key is F4 (key code 115)
        else if (event.keyCode === 115) {
            document.getElementById('draft-btn').click();
        }
        // Check if the pressed key is F6 (key code 117)
        else if (event.keyCode === 117) {
            document.getElementById('gift-card-btn').click();
        }
        // Check if the pressed key is F7 (key code 118)
        else if (event.keyCode === 118) {
            document.getElementById('cash-btn').click();
        }
        // Check if the pressed key is F8 (key code 119)
        else if (event.keyCode === 119) {
            document.getElementById('deposit-btn').click();
        }
        // Check if the pressed key is F9 (key code 120)
        else if (event.keyCode === 120) {
            document.getElementById('cheque-btn').click();
        }
        // Check if the pressed key is F10 (key code 121)
        else if (event.keyCode === 121) {
            document.getElementById('point-btn').click();
        }
...
$(document).ready(function() {
    @if($general_setting->pos_date_disable)
        ...
        createdAtInput.setAttribute('readonly', 'true');

        /*var currentDate = new Date();
        var formattedDate = currentDate.toISOString().split('T')[0]; // Get YYYY-MM-DD format
        var createdAtInput = document.getElementById('created_at');    
        createdAtInput.value = formattedDate;
        createdAtInput.setAttribute('readonly', 'false');*/
    @else
...
function populateProduct(data) {
    ...
    if (Object.keys(data).length != 0) {
        $.each(data['name'], function(index) {
            ...
            if(index == 1){
                tableData += '<tr class="product-ways-class">'+data['p_type'][index]+'</tr>';
            }
...
$("#draft-btn").on("click",function(){
    $('input[name="multi_payment_chk"]').val(0);
    var audio = $("#mysoundclip2")[0];
    audio.play();
...
$("#add-payment #submit-btn").on("click", function() {
    $('.payment-form').submit();
});

$("#add-multi-payment #submit-btn").on("click", function() {
    $('.payment-form').submit();
});
...
$("#multi-payment-btn").on("click",function() {
    $('select[name="paid_by_id_select"]').val(1);
    $('.selectpicker').selectpicker('refresh');
    $('div.qc').hide();
    $('#add-multi-payment input[type="text"]').val('');
    $('#add-multi-payment input[type="hidden"]').val('');
    $('#add-multi-payment select').prop('selectedIndex', 0);
    $('#add-multi-payment textarea').val('');
    $('#add-multi-payment #change #change_1 #change_2 #change_3').text('0'); // Assuming 'change' is an element ID

    // Add additional clearing logic for other elements as needed

    // You may also hide elements if needed
    $('#add-multi-payment .gift-card').hide();
    $('#add-multi-payment .cheque_multi').hide();
    $('input[name="paid_amount_0"]').val($("#grand-total").text());
    $('input[name="paying_amount_0"]').val($("#grand-total").text());
    $('.qc').data('initial', 1);
    $('input[name="multi_payment_chk"]').val(1);
});
...
$('select[name="paid_by_id_select_0"]').on("change", function() {
    //debugger;
    var id = $(this).val();
    $(".payment-form").off("submit");
    if(id == 2) {
...
$('select[name="paid_by_id_select_1"]').on("change", function() {
    //debugger;
    var id = $(this).val();
    $(".payment-form").off("submit");
    if(id == 2) {
...
$('select[name="paid_by_id_select_2"]').on("change", function() {
    //debugger;
    var id = $(this).val();
    $(".payment-form").off("submit");
    if(id == 2) {
...
$('select[name="paid_by_id_select_3"]').on("change", function() {
    //debugger;
    var id = $(this).val();
    $(".payment-form").off("submit");
    if(id == 2) {
...
$('input[name="paid_amount_0"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount_0"]').val()) ) {
        alert('Paying amount cannot be bigger than recieved amount');
        $(this).val('');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
    ...
    change0( $('input[name="paying_amount_0"]').val(), $(this).val() );
    var id = $('select[name="paid_by_id_select_0"]').val();
    if(id == 2){
        var balance = gift_card_amount[$("#gift_card_id_select").val()] - gift_card_expense[$("#gift_card_id_select").val()];
        if($(this).val() > balance)
            alert('Amount exceeds card balance! Gift Card balance: '+ balance);
        ...
        if( $('input[name="paid_amount_0"]').val() > deposit[$('#customer_id').val()] )
            alert('Amount exceeds customer deposit! Customer deposit : '+ deposit[$('#customer_id').val()]);
    }

    $('input[name="paying_amount_1"]').val( parseFloat($('input[name="paying_amount_0"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );

});

$('input[name="paid_amount_1"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount_1"]').val()) ) {
        alert('Paying amount cannot be bigger than recieved amount');
        $(this).val('');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
    ...
    change1( $('input[name="paying_amount_1"]').val(), $(this).val() );
   /*("#change_1").text( parseFloat($('input[name="paying_amount_1"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );*/
    var id = $('select[name="paid_by_id_select_1"]').val();
    if(id == 2){
        var balance = gift_card_amount[$("#gift_card_id_select").val()] - gift_card_expense[$("#gift_card_id_select").val()];
        if($(this).val() > balance)
            alert('Amount exceeds card balance! Gift Card balance: '+ balance);
        ...
        if( $('input[name="paid_amount_1"]').val() > deposit[$('#customer_id').val()] )
            alert('Amount exceeds customer deposit! Customer deposit : '+ deposit[$('#customer_id').val()]);
    }

    $('input[name="paying_amount_2"]').val( parseFloat($('input[name="paying_amount_1"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );

});

$('input[name="paid_amount_2"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount_2"]').val()) ) {
        alert('Paying amount cannot be bigger than recieved amount');
        $(this).val('');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
    ...
    change2( $('input[name="paying_amount_2"]').val(), $(this).val() );
   /*("#change_2").text( parseFloat($('input[name="paying_amount_2"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );*/
    var id = $('select[name="paid_by_id_select_2"]').val();
    if(id == 2){
        var balance = gift_card_amount[$("#gift_card_id_select").val()] - gift_card_expense[$("#gift_card_id_select").val()];
        if($(this).val() > balance)
            alert('Amount exceeds card balance! Gift Card balance: '+ balance);
        ...
        if( $('input[name="paid_amount_2"]').val() > deposit[$('#customer_id').val()] )
            alert('Amount exceeds customer deposit! Customer deposit : '+ deposit[$('#customer_id').val()]);
    }

    $('input[name="paying_amount_3"]').val( parseFloat($('input[name="paying_amount_2"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );

});

$('input[name="paid_amount_3"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount_3"]').val()) ) {
        alert('Paying amount cannot be bigger than recieved amount');
        $(this).val('');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
    ...
    change3( $('input[name="paying_amount_3"]').val(), $(this).val() );
   /*("#change_3").text( parseFloat($('input[name="paying_amount_3"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );*/
    var id = $('select[name="paid_by_id_select_3"]').val();
    if(id == 2){
        var balance = gift_card_amount[$("#gift_card_id_select").val()] - gift_card_expense[$("#gift_card_id_select").val()];
        if($(this).val() > balance)
            alert('Amount exceeds card balance! Gift Card balance: '+ balance);
        ...
        if( $('input[name="paid_amount_3"]').val() > deposit[$('#customer_id').val()] )
            alert('Amount exceeds customer deposit! Customer deposit : '+ deposit[$('#customer_id').val()]);
    }

    //$('input[name="paying_amount_4"]').val( parseFloat($('input[name="paying_amount_3"]').val() - $(this).val()).toFixed({{$general_setting->decimal}}) );
...
function addNewProduct(data){
    ...
    /*cols += '<select class="form-control" name="imei_number[]" multiple>';
...
function edit(){
    ...
    if(is_imei[rowindex]) {
        ...
        var batch_id = product_batch_id;
        /*debugger;*/
        //var imeiNumbers = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.imei-number').val();
        //htmlText = '<div class="col-md-12 form-group imei-section"><label>IMEI or Serial Numbers</label>';
        // htmlText += '<input type="text" name="imei_numbers" value="'+imeiNumbers+'" class="form-control imei_number" placeholder="Type imei or serial numbers and separate them by comma. Example:1001,2001" step="any">';

        /* Adding New Code Here Start */

        htmlText = '<div class="col-md-12 form-group imei-section"><label>IMEI or Serial Numbers </label>';
        htmlText += '<br>';
        // htmlText += '<select class="form-control imei_number" name="imei_numbers[]" multiple="multiple">';

        $.ajax({
            type: 'GET',
            async: false,
            url: 'sales/get_imei_numbers?batch_id='+batch_id+'&product_id='+product_id,
            success: function(data) {
                // console.log(data[1]);
                /*$.each(data[1], function(key, value) {
                    htmlText += '<option value="' + value + '">' + value + '</option>';
                });*/
                htmlText += '<span> Serial #: ' + data[0] + '</span>';
            }
        });
        // htmlText += '</select>';
        htmlText += '<input type="text" name="imei_numbers" value="'+imeiNumbers+'" class="form-control imei_number" placeholder="Type imei or serial numbers and separate them by comma. Example:1001,2001" step="any">';
        htmlText +='</div>';
        /* Adding New Code Here End */
...
function hide() {
    ...
    $('input[name="cheque_no_multi"]').attr('required', false);
...
function cheque1() {
    $(".cheque_multi").show();
    $('input[name="cheque_no_multi"]').attr('required', true);
    $(".card-element").hide();
    $(".card-errors").hide();
    $(".gift-card").hide();
}
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    if( parseFloat( $('input[name="paying_amount_0"]').val() ) > 0 ){
        if( parseFloat( $('input[name="paying_amount_0"]').val() ) < parseFloat( $('input[name="paid_amount_0"]').val() ) ){
            alert('Paying amount cannot be bigger than recieved amount');
            e.preventDefault();
        }
        else if( parseFloat( $('input[name="paying_amount_1"]').val() ) < parseFloat( $('input[name="paid_amount_1"]').val() ) ){
            alert('Paying amount cannot be bigger than recieved amount');
            e.preventDefault();
        }
        else if( parseFloat( $('input[name="paying_amount_2"]').val() ) < parseFloat( $('input[name="paid_amount_2"]').val() ) ){
            alert('Paying amount cannot be bigger than recieved amount');
            e.preventDefault();
        }
        else if( parseFloat( $('input[name="paying_amount_3"]').val() ) < parseFloat( $('input[name="paid_amount_3"]').val() ) ){
            alert('Paying amount cannot be bigger than recieved amount');
            e.preventDefault();
        }
    }
    ...
    if( parseFloat( $('input[name="paid_amount_0"]').val() ) > 0 ){
        $('input[name="paid_by_id_0"]').val($('select[name="paid_by_id_select_0"]').val());
    }
    if( parseFloat( $('input[name="paid_amount_1"]').val() ) > 0 ){
        $('input[name="paid_by_id_1"]').val($('select[name="paid_by_id_select_1"]').val());
    }
    if( parseFloat( $('input[name="paid_amount_2"]').val() ) > 0 ){
        $('input[name="paid_by_id_2"]').val($('select[name="paid_by_id_select_2"]').val());
    }
    if( parseFloat( $('input[name="paid_amount_3"]').val() ) > 0 ){
        $('input[name="paid_by_id_3"]').val($('select[name="paid_by_id_select_3"]').val());
    }
