                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{'Pos Date Disable'}}</label><br>
                                        @if($lims_general_setting_data->pos_date_disable)
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_date" value="1" checked> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_date" value="0"> {{trans('file.No')}}
                                        </label>
                                        @else
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_date" value="1"> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_date" value="0" checked> {{trans('file.No')}}
                                        </label>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{'Pos Reference Disable'}}</label><br>
                                        @if($lims_general_setting_data->pos_reference_disable)
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_reference" value="1" checked> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_reference" value="0"> {{trans('file.No')}}
                                        </label>
                                        @else
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_reference" value="1"> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_reference" value="0" checked> {{trans('file.No')}}
                                        </label>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{'Pos Multi Currency Print'}}</label><br>
                                        @if($lims_general_setting_data->pos_currency_check == "yes")
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_currency" value="yes" checked> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_currency" value="no"> {{trans('file.No')}}
                                        </label>
                                        @else
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_currency" value="yes"> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_currency" value="no" checked> {{trans('file.No')}}
                                        </label>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{'Pos Currency Multi Selection Option'}}</label><br>
                                        @if($lims_general_setting_data->pos_currency_sel_change)
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_currency_sel_change" value="1" checked> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_currency_sel_change" value="0"> {{trans('file.No')}}
                                        </label>
                                        @else
                                        <label class="radio-inline">
                                            <input type="radio" name="pos_currency_sel_change" value="1"> {{trans('file.Yes')}}
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="pos_currency_sel_change" value="0" checked> {{trans('file.No')}}
                                        </label>
                                        @endif
                                    </div>
                                </div>
