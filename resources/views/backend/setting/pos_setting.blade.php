                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 d-flex justify-content-between">
                                    ...
                                    <div class="form-group d-inline">
                                        ...
                                        <input class="mt-2" type="checkbox" name="options[]" value="multi_payment" checked>
                                        @else
                                        <input class="mt-2" type="checkbox" name="options[]" value="multi_payment">
                                        @endif
                                        <label class="mt-2"><strong>Multi Payment</strong></label>
                                    </div>
