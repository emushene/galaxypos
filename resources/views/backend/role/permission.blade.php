                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
						        ...
						        <!-- New Codwe Start-->
						        @if(Auth::user()->id == 1 && $lims_role_data->id == 1)
						        <tr>
						            <td>{{'License All Permission'}}</td>
						            <td class="report-permissions" colspan="5">
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("license", $all_permission))
							                    	<input type="checkbox" value="1" id="license" name="license" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="license" name="license">
							                    	@endif
								                    <label for="license" class="padding05">{{'License'}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            </td>
						            	...
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="pos_void" name="pos_void" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="pos_void" name="pos_void">
							                    	@endif
								                    <label for="pos_void" class="padding05">{{'Enable Void Option in POS Screen'}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            </td>
