                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{'Product Barcode'}}</strong> </label>
                                        <div class="input-group">
                                            <input type="text" name="prodcut_barcode" value="{{$lims_product_data->product_barcode}}" class="form-control" id="prodcut_barcode" aria-describedby="code">
                                        </div>
                                        <span class="validation-msg" id="code-error"></span>
                                    </div>
                                </div>
