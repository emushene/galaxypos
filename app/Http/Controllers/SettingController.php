...
class SettingController extends Controller
{
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        $general_setting->pos_date_disable = $data['pos_date']; /* New Developed */
        $general_setting->pos_reference_disable = $data['pos_reference']; /* New Developed */        
        $general_setting->pos_currency_check = $data['pos_currency']; /* New Developed */        
        $general_setting->pos_currency_sel_change = $data['pos_currency_sel_change']; /* New Developed */        
