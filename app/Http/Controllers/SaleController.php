...
class SaleController extends Controller
{
    ...
    {
        $data = $request->all();
        //dd($data, $data['multi_payment_chk']);
        //return $data;
        /*DB::beginTransaction();
        try {*/
            ...
            if(isset($data['multi_payment_chk']) && $data['multi_payment_chk'] == 1){ /* New Code Going Start Here */
                ...
                if($data['pos']) {
                    ...
                    $balance = $data['grand_total'] - $data['paid_amount_0'];
                    $data['paid_amount'] = $data['paid_amount_0'];
                    if($balance > 0 || $balance < 0) {
                        $data['payment_status'] = 2;
                    } else {
                        $data['payment_status'] = 4;
                    }
                    if($data['paid_amount_1'] > 0 && $data['paid_amount_1'] != null){
                        $data['paid_amount'] = $data['paid_amount'] + $data['paid_amount_1'];
                        $balance = $balance - $data['paid_amount_1'];
                        if($balance > 0 || $balance < 0)
                            $data['payment_status'] = 2;
                        else
                            $data['payment_status'] = 4;
                    }
                    if($data['paid_amount_2'] > 0 && $data['paid_amount_2'] != null){
                        $data['paid_amount'] = $data['paid_amount'] + $data['paid_amount_2'];
                        $balance = $balance - $data['paid_amount_2'];
                        if($balance > 0 || $balance < 0)
                            $data['payment_status'] = 2;
                        else
                            $data['payment_status'] = 4;
                    }
                    if($data['paid_amount_3'] > 0 && $data['paid_amount_3'] != null){
                        $data['paid_amount'] = $data['paid_amount'] + $data['paid_amount_3'];
                        $balance = $balance - $data['paid_amount_3'];
                        if($balance > 0 || $balance < 0)
                            $data['payment_status'] = 2;
                        else
                            $data['payment_status'] = 4;
                ...
                $data['sale_note'] = $data['sale_note_multi'];
                $data['staff_note'] = $data['staff_note_multi'];
                ...
                if($data['payment_status'] == 3 || $data['payment_status'] == 4 || ($data['payment_status'] == 2 && $data['pos'])) {

                    if($data['paid_amount_0'] > 0 && $data['paid_amount_0'] != null){

                        $lims_payment_data = new Payment();
                        $lims_payment_data->user_id = Auth::id();

                        if($data['paid_by_id_0'] == 1) {
                            $paying_method = 'Cash';
                        } elseif ($data['paid_by_id_0'] == 2) {
                            $paying_method = 'Gift Card';
                        } elseif ($data['paid_by_id_0'] == 3) {
                            $paying_method = 'Credit Card';
                        } elseif ($data['paid_by_id_0'] == 4) {
                            $paying_method = 'Cheque';
                        } elseif ($data['paid_by_id_0'] == 5) {
                            $paying_method = 'Paypal';
                        } elseif ($data['paid_by_id_0'] == 6) {
                            $paying_method = 'Deposit';
                        } elseif ($data['paid_by_id_0'] == 7) {
                        ...
                        $lims_payment_data->amount = $data['paid_amount_0'];
                        $lims_payment_data->change = $data['paying_amount_0'] - $data['paid_amount_0'];
                        ...
                        elseif ($paying_method == 'Gift Card') {
                            ...
                            $lims_gift_card_data->expense += $data['paid_amount_0'];
                            $lims_gift_card_data->save();
                            PaymentWithGiftCard::create($data);
                        }
                        elseif ($paying_method == 'Cheque') {
                            if($data['cheque_no_multi'] != null){
                                $data['cheque_no'] = $data['cheque_no_multi'];
                            }
                        ...
                        elseif($paying_method == 'Deposit'){
                            $lims_customer_data->expense += $data['paid_amount_0'];
                            $lims_customer_data->save();
                        }
                    ...
                    if($data['paid_amount_1'] > 0 && $data['paid_amount_1'] != null){
                        ...
                        if($data['paid_by_id_1'] == 1) {
                            $paying_method = 'Cash';
                        } elseif ($data['paid_by_id_1'] == 2) {
                            $paying_method = 'Gift Card';
                        } elseif ($data['paid_by_id_1'] == 3) {
                            $paying_method = 'Credit Card';
                        } elseif ($data['paid_by_id_1'] == 4) {
                            $paying_method = 'Cheque';
                        } elseif ($data['paid_by_id_1'] == 5) {
                            $paying_method = 'Paypal';
                        } elseif ($data['paid_by_id_1'] == 6) {
                            $paying_method = 'Deposit';
                        } elseif ($data['paid_by_id_1'] == 7) {
                            $paying_method = 'Points';
                            $lims_payment_data->used_points = $data['used_points'];
                        }
                        ...
                        $data['payment_reference'] = 'spr-'.date("Ymd").'-'.date("his");
                        $lims_payment_data->payment_reference = $data['payment_reference'];
                        $lims_payment_data->amount = $data['paid_amount_1'];
                        $lims_payment_data->change = $data['paying_amount_1'] - $data['paid_amount_1'];
                        $lims_payment_data->paying_method = $paying_method;
                        $lims_payment_data->payment_note = $data['payment_note'];
                        $lims_payment_data->save();
                        ...
                        elseif ($paying_method == 'Gift Card') {
                            $lims_gift_card_data = GiftCard::find($data['gift_card_id']);
                            $lims_gift_card_data->expense += $data['paid_amount_1'];
                            $lims_gift_card_data->save();
                            PaymentWithGiftCard::create($data);
                        }
                        elseif ($paying_method == 'Cheque') {
                        ...
                        elseif($paying_method == 'Deposit'){
                            $lims_customer_data->expense += $data['paid_amount_1'];
                            $lims_customer_data->save();
                        }
                        elseif($paying_method == 'Points'){
                            $lims_customer_data->points -= $data['used_points'];
                    ...
                    if($data['paid_amount_2'] > 0 && $data['paid_amount_2'] != null){
                        ...
                        if($data['paid_by_id_2'] == 1) {
                            $paying_method = 'Cash';
                        } elseif ($data['paid_by_id_2'] == 2) {
                            $paying_method = 'Gift Card';
                        } elseif ($data['paid_by_id_2'] == 3) {
                            $paying_method = 'Credit Card';
                        } elseif ($data['paid_by_id_2'] == 4) {
                            $paying_method = 'Cheque';
                        } elseif ($data['paid_by_id_2'] == 5) {
                            $paying_method = 'Paypal';
                        } elseif ($data['paid_by_id_2'] == 6) {
                            $paying_method = 'Deposit';
                        } elseif ($data['paid_by_id_2'] == 7) {
                            $paying_method = 'Points';
                            $lims_payment_data->used_points = $data['used_points'];
                        }
                        ...
                        $data['payment_reference'] = 'spr-'.date("Ymd").'-'.date("his");
                        $lims_payment_data->payment_reference = $data['payment_reference'];
                        $lims_payment_data->amount = $data['paid_amount_2'];
                        $lims_payment_data->change = $data['paying_amount_2'] - $data['paid_amount_2'];
                        $lims_payment_data->paying_method = $paying_method;
                        $lims_payment_data->payment_note = $data['payment_note'];
                        $lims_payment_data->save();
                        ...
                        elseif ($paying_method == 'Gift Card') {
                            $lims_gift_card_data = GiftCard::find($data['gift_card_id']);
                            $lims_gift_card_data->expense += $data['paid_amount_2'];
                            $lims_gift_card_data->save();
                            PaymentWithGiftCard::create($data);
                        }
                        elseif ($paying_method == 'Cheque') {
                        ...
                        elseif($paying_method == 'Deposit'){
                            $lims_customer_data->expense += $data['paid_amount_2'];
                            $lims_customer_data->save();
                        }
                        elseif($paying_method == 'Points'){
                            $lims_customer_data->points -= $data['used_points'];
                    ...
                    if($data['paid_amount_3'] > 0 && $data['paid_amount_3'] != null){
                        ...
                        if($data['paid_by_id_3'] == 1) {
                            $paying_method = 'Cash';
                        } elseif ($data['paid_by_id_3'] == 2) {
                            $paying_method = 'Gift Card';
                        } elseif ($data['paid_by_id_3'] == 3) {
                            $paying_method = 'Credit Card';
                        } elseif ($data['paid_by_id_3'] == 4) {
                            $paying_method = 'Cheque';
                        } elseif ($data['paid_by_id_3'] == 5) {
                            $paying_method = 'Paypal';
                        } elseif ($data['paid_by_id_3'] == 6) {
                            $paying_method = 'Deposit';
                        } elseif ($data['paid_by_id_3'] == 7) {
                            $paying_method = 'Points';
                            $lims_payment_data->used_points = $data['used_points'];
                        }
                        ...
                        $data['payment_reference'] = 'spr-'.date("Ymd").'-'.date("his");
                        $lims_payment_data->payment_reference = $data['payment_reference'];
                        $lims_payment_data->amount = $data['paid_amount_3'];
                        $lims_payment_data->change = $data['paying_amount_3'] - $data['paid_amount_3'];
                        $lims_payment_data->paying_method = $paying_method;
                        $lims_payment_data->payment_note = $data['payment_note'];
                        $lims_payment_data->save();
                        ...
                        elseif ($paying_method == 'Gift Card') {
                            $lims_gift_card_data = GiftCard::find($data['gift_card_id']);
                            $lims_gift_card_data->expense += $data['paid_amount_3'];
                            $lims_gift_card_data->save();
                            PaymentWithGiftCard::create($data);
                        }
                        elseif ($paying_method == 'Cheque') {
                        ...
                        elseif($paying_method == 'Deposit'){
                            $lims_customer_data->expense += $data['paid_amount_3'];
                            $lims_customer_data->save();
                        }
                        elseif($paying_method == 'Points'){
                            $lims_customer_data->points -= $data['used_points'];
                ...
                if($data['pos']) {
                    ...
                    if($data['paying_amount_1'] > 0){
                        $balance = $balance - $data['paying_amount_1'];
                        if($balance > 0 || $balance < 0)
                            $data['payment_status'] = 2;
                        else
                            $data['payment_status'] = 4;
    ...
    public function getProductByFilter($category_id, $brand_id)
    {
        ...
        if(($category_id != 0) && ($brand_id != 0)){
            $p_type = 'Category & Brand Products';
        ...
        foreach ($lims_product_list as $product) {
            if($product->is_variant) {
                ...
                foreach ($lims_product_variant_data as $key => $variant) {
                    $data['name'][$index] = $product->name.' ['.$variant->name.']';
                    $data['code'][$index] = $variant->pivot['item_code'];
                    $data['p_type'][$index] = 'Featured Products';
                    $images = explode(",", $product->image);
                    $data['image'][$index] = $images[0];
                    $index++;
                }
    ...
    {   
        ...
        $product[] = $qty;
        $product[] = $lims_product_data->product_barcode;

        /* Adding New Code Here Start */
        if($lims_product_data->is_imei == 1){
             
            $product_sales_data = Product_Sale::join('sales', 'product_sales.sale_id', '=', 'sales.id')
                ->join('product_batches', 'product_batches.id', '=', 'product_sales.product_batch_id')
                ->where([
                    ['product_sales.product_id', $lims_product_data->id],
                    // ['product_sales.product_batch_id', $product_sale->product_batch_id],
                ])
                ->select('product_sales.*')
                ->orderBy('product_sales.sale_id', 'DESC')->get();
            ...
            if(empty($product_sales_data)){
                ...
                $product_purchase_data = Purchase::join('product_purchases', 'purchases.id', '=', 'product_purchases.purchase_id')
                        ->join('product_batches', 'product_batches.id', '=', 'product_purchases.product_batch_id')
                        ->where([
                            ['product_purchases.product_id', $lims_product_data->id],
                            // ['product_purchases.product_batch_id', $product_sale->product_batch_id],
                        ])
                        ->select('product_purchases.*')
                        ->orderBy('product_purchases.purchase_id', 'DESC')->first();

                $product[] = $product_purchase_data->imei_number;
                /*return $product;*/
                ...
                $string_imei_number ='';
                foreach ($product_sales_data as $key => $sales_data) {
                    $string_imei_number .= $sales_data->imei_number.',';                
                }
                
                $purchase_imei_number = explode(',', $product_purchase_data->imei_number);
                $sale_imei_number = explode(',', $string_imei_number);

                $compare_imei_num=array_diff($purchase_imei_number,$sale_imei_number);
                sort($compare_imei_num);

                $implode_imei_number = implode(',', $compare_imei_num);

                $product[] = $implode_imei_number;
                /*return $product;*/
            ...
            /*$product_purchase_data = Purchase::join('product_purchases', 'purchases.id', '=', 'product_purchases.purchase_id')
                    ...
                    ->orderBy('product_purchases.purchase_id', 'DESC')->first();
            //dd($product_purchase_data);

            $imei_number = explode(',', $product_purchase_data->imei_number);
    ...
    public function getIMEINumbers(Request $request){
        ...
        $product_sales_data = Product_Sale::join('sales', 'product_sales.sale_id', '=', 'sales.id')
                ...
                ->where([
                    ...
                    ['product_sales.product_batch_id', $batch_id],
                ])
                ->select('product_sales.*')
                ->orderBy('product_sales.sale_id', 'DESC')->get();
        ...
        if(empty($product_sales_data)){
            ...
            $product_purchase_data = Purchase::join('product_purchases', 'purchases.id', '=', 'product_purchases.purchase_id')
                    ...
                    ->where([
                        ...
                        ['product_purchases.product_batch_id', $batch_id],
                    ])
                    ->select('product_purchases.*')
                    ->orderBy('product_purchases.purchase_id', 'DESC')->first();
    ...
    public function genInvoice($id)
    {
        ...
        $currency_list = Currency::where('is_active', true)->get();
        $product_sale_data_id = Product_Sale::where('sale_id', $id)->first();
        $lims_product_data = Product::find($product_sale_data_id->product_id);

        // dd($lims_product_data);
        if($lims_pos_setting_data->invoice_option == 'A4') {
            return view('backend.sale.a4_invoice', compact('lims_sale_data', 'currency_code', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'paid_by_info', 'sale_custom_fields', 'customer_custom_fields', 'product_custom_fields', 'qrText', 'currency_list'));
        }
        else{
            return view('backend.sale.invoice', compact('lims_sale_data', 'currency_code', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'sale_custom_fields', 'customer_custom_fields', 'product_custom_fields', 'qrText', 'currency_list', 'numberTransformer'));
        }
